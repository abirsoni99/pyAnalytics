...
y #DV #(y can 1 dim also without y.reshape((-1,1)))
...
#new values --- ignore as the values have not been included in the model development
...
x
#[x1,x2] is the fashion of the values
...
#%% Stats Models --- better approach gives all test results as well
...
x= sm.add_constant(x)  #constant term of 1 added === to have an intercept
x
